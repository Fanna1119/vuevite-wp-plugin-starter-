 ...
 * Plugin URI:        pluginname.com
 * Description:       This is a short description of what the plugin does. It's displayed in the WordPress admin area.
 * Version:           1.0.0
 * Author:            Vue WordPress
 * Author URI:        pluginname.com
 * License:           GPL-2.0+
...
class VwpPlugin
{
  ...
  {
    wp_enqueue_style("$this->plugin-css", plugins_url('/dist/_assets/styles.css', __FILE__));
    wp_enqueue_script("$this->plugin-js", plugins_url('/dist/_assets/scripts.js', __FILE__), null, null, true);
  }
